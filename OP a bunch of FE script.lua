...
local Tab = Window:NewTab("prizzlife admin")

local Section = Tab:NewSection("prison life admin")
...
local Tab = Window:NewTab("Fe punch")

local Section = Tab:NewSection("punch")
...
local Tab = Window:NewTab("coolkidd SCRIPT CLIENT SIDE")

local Section = Tab:NewSection("coolkidd script no one see")
...
local Tab = Window:NewTab("Prisonware")

local Section = Tab:NewSection("prisonware")
Section:NewButton("ButtonText", "ButtonInfo", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Denverrz/scripts/master/PRISONWARE_v1.3.txt"))();
end)
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Tab = Window:NewTab("jerk off lol umm")
local Section = Tab:NewSection("R6")
Section:NewButton("ButtonText", "ButtonInfo", function()
loadstring(game:HttpGet("https://pastefy.app/wa3v2Vgm/raw"))("Spider Script")
end)
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Tab = Window:NewTab("tool giver")
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Tab = Window:NewTab("Rc7")
local Section = Tab:NewSection("EXECUTOR")
Section:NewButton("ButtonText", "ButtonInfo", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/CoreGui/Scripts/main/RC7"))()
end)
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Tab = Window:NewTab("tiger admin finnaly last script took me foverer")
local Section = Tab:NewSection("tiger")
Section:NewButton("ButtonText", "ButtonInfo", function()
